...
<title>租屋資訊修改 - update_rhi_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>租屋資訊修改 - update_rhi_input.jsp</h3>
...
<table class="form">
	<tr>
		<td>租屋資訊編號：<font color=red><b>*</b></font></td>
		<td><%=rhiVO.getRhi_no()%></td>
	</tr>
	<tr>
		<td>租屋資訊內容：</td>
		<td><input type="TEXT" name="rhi_content" size="45" value="<%=rhiVO.getRhi_content()%>" /></td>
	</tr>
	<tr>
		<td>租屋資訊狀態：</td>
	...
	<tr>
		<td>租屋資訊刊登日期：</td>
		<td><input name="rhi_date" id="f_date1" type="text" ></td>
	</tr>
	<tr>
		<td>租屋圖片上傳1：</td>
...
<input type="hidden" name="rhi_no" value="<%=rhiVO.getRhi_no()%>">
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=rhiVO.getRhi_date()%>', // value:   new Date(),
